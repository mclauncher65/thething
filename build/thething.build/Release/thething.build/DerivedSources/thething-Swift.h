...
#ifndef THETHING_SWIFT_H
#define THETHING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="thething",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSButton;
SWIFT_CLASS("_TtC8thething5Alert")
@interface Alert : NSWindow
- (IBAction)setModeFinish:(NSButton * _Nonnull)_;
...
SWIFT_EXTERN void RecordKeyCode_Swift(void) SWIFT_NOEXCEPT;

SWIFT_EXTERN void StopRecordKeyCode_Swift(void) SWIFT_NOEXCEPT;
